...
public class CalcSettings implements Parcelable {
    ...
    @Nullable
    BigDecimal minValue = new BigDecimal("-1E10");
    // Appearance settings
    @NonNull
    ...
    private CalcDialog.CalcDialogCallback callback;
    ...
    private CalcSettings(Parcel in) {
        Bundle bundle = in.readBundle(getClass()
                .getClassLoader());
        if (bundle != null) {
    ...
    public CalcDialog.CalcDialogCallback getCallback() {
        return callback;
    }

    public void setCallback(CalcDialog.CalcDialogCallback callback) {
    ...
    public void writeToParcel(@NonNull Parcel out, int flags) {
        ...
        if (initialValue != null) {
            bundle.putSerializable("initialValue", initialValue);
        }
        if (minValue != null) {
